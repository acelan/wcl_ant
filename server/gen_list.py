...
server_data = {
        "5053": {
            ...
            "guildlist": ["無與倫比的自由", "MyGO!!!!!", "Ice Crown", "喵喵叫的小伙伴们", "風月衝鋒團", "上海问题青年", "微风再拂", "黄昏酒馆", "逆天", "★逆天★", "Impact", "老年混子團", "Manny Club 亚服", "鷄戰", "FriendShipClub", "小喬流水人傢", "雲頂小築", "明儿有雨", "广电总局", "南瓜小学丶学前班", "龍 門", "肥腸", "福尔图娜", "老兵亞服分會", "★風月同天★", "天空之墙", "嘎了給給", "膘巴>達", "无册么赫", "死亡之翼", "我真的没有骗你", "家园-玛拉顿", "甘寧周罵渡假村", "爲你寫詩", "奧斯卡演員", "魔界炎帝", "倚竹醉酒笑紅塵", "卓越漂流", "IKEA of Avalon", "好久不見", "餐桌騎士團", "無與倫比的自由", "貪婪的冒險者"]
            },
        "5052": {
            "name" : "伊弗斯",
            "userlist" : ["1231180", "973644", "690499"],
            "guildlist": ["Noobs Int", "万焰公会", "荣耀", "大雷瓜棚", "猫窝", "超越周四团（+V：jerry6630）", "Everything In The Dream", "永遠叫不醒一個裝睡的人", "起点远>征军", "年糕乐园", "鸽们-伊弗斯", "艾歐尼亞天空-伊弗斯", "世2鸟哈神的水友团", "SSIS-413", "亞服10人團", "少年遊", "細雨紛飛", "八卦集中營", "唷唷", "No Fear 2.0", "Asgard备战ICC招DK/SS，微信号15111353582", "Aurora", "IFC1", "雁渡寒潭", "等下要吃什麼", "倚楼听風雨（亚服）", "二萬二良心企業", "Rbae Style", "凑拢班子", "你想證明什麼", "八点整", "微醺沙發", "索爾的一棟城堡", "A Star", "贝塔β招募+V：PoP-SteP", "熊克萨的春天", "夜半時光", "安西軍", "阿魯", "Play for uber", "Ouroboros", "MIKO", "吃瓜真香", "300 P", "鵝魚我炸", "OOPS 10人團", "RL每次都搞", "滿滿和她的男人們", "浪團", "Fertty"],
            },
        "5205": {
            "name" : "烏蘇雷",
            "userlist" : [],
