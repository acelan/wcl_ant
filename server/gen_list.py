...
server_data = {
        ...
        "5052": {
            ...
            "guildlist": ["35好友", "A Star", "Dark Tranquillity", "End", "Fertty", "GGR", "Gladiolus禮拜四五", "Hall of Fame", "Meteora", "O O P S", "Ouroboros", "Protosss", "RL每次都搞", "SSIS-413", "Source of Chaos", "Source of Chaos 2團", "Source of Chaos 週四團", "Source of Chaos 週日團", "i have a dream", "✮PanTheon✮", "✮PanTheon✮Ⅱ", "一树梨花白", "乂橘子乂", "二萬二良心企業", "你不行的家", "你想證明什麼", "吃瓜真香", "周防有希粉絲俱樂部", "夜半時光", "安西軍", "戰士長", "等下要吃什麼", "索爾的一棟城堡", "細雨紛飛", "胖丁金團", "艾歐尼亞天空-伊弗斯", "薄荷葉", "走向共和", "重生之再见伊弗斯", "開心教", "雙足飛龍菅理員", "韶光", "香城", "香草山", "黑暗藝術"],
            },
        "5205": {
            "name" : "烏蘇雷",
            "userlist" : ["1896889", "486041", "1535244", "2371907", "1052681", "902871", "353477", "2249924", "859477", "642089", "310995"],
            "guildlist": ["Nuke-鸽王争霸", "伊卡洛斯和他的伙伴们", "Dark Tranquillity", "离殇", "P A S", "Meow Boss Gaming", "yseraskyCTM", "The Ran Beach Legion", "Hey Chocolate", "黑手兄弟會", "小喵团台服分舵", "至死不渝", "金陵世家 霜月团", "DrumstickG团", "寒脊山之光", "永 夜 休闲团", "无糖乌苏雷四海为家", "无>糖乌苏雷", "小拳拳幫", "缘起", "鹅城", "誠 諾灬烏蘇雷", "乌鸦团", "千钧一发台服", "颤粟-乌蘇雷", "伊卡洛斯的小伙伴", "LSP驻台办", "为了方便吹逼迫不得已组建的工会", "远征-乌苏雷", "大聪明", "in time", "隨便拉", "marsh", "炎魔之灵", "科语然"],
            },
        }
