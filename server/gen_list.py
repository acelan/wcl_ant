...
server_data = {
        "5053": {
            ...
            "guildlist": ["無與倫比的自由", "QAQ", "老兄村", "One Piece", "CTR", "末日天使", "Pallas", "淘金(G)團", "Nemesis", "啾尼爾", "SoF", "我只會心疼哥哥", " 黑手別黑本阿會長說我們只收歐洲人不收非洲人", " 自由殿堂", "IMBA", "信董爽歪歪", "黑玫瑰", "糕餅舖", "輪迴夢境", "镶金玫瑰", "傲雪紛飛"]
            },
        "5052": {
            "name" : "伊弗斯",
            "userlist" : [],
            "guildlist": ["極限鐵盒六團", "Legend of Defiler", " 壞寶寶聯盟我只信好牧", "軍師 聯盟", " Remix", " Destiny Breaker", "i have a dream", " 撿到槍一團", "樹蛙娛樂", "咖波與他的快樂夥伴", "吃瓜真香", "邊境小鎮", "艾歐尼亞天空-伊弗斯", "古老神話", "Avengers", "TW 野團", "Rely EX", "肥羊王G團", "Dawang Gaming", "寂寞謳歌", "二萬二良心企業", "提里斯法守護者", "薄荷葉", "WCL LOGS", "Island of Greed", "「粗」「四」wow30cm.tw", "神羅天征"],
            },
        }
